  ...
  $.app.menu = {
    ...
    transit: function (callback1, callback2) {
      ...
      if ($body.hasClass('vertical-layout')) {
        if ($body.hasClass('menu-open') || $body.hasClass('menu-collapsed')) {
    ...
    open: function () {
      this.transit(
        function () {
          $body.removeClass('menu-hide menu-expanded').addClass('menu-open');
          this.hidden = false;
          this.expanded = true;
    ...
    hide: function () {
      this.transit(
        function () {
          $body.removeClass('menu-open menu-collapsed').addClass('menu-hide');
          this.hidden = true;
          this.expanded = false;
    ...
    reset: function () {
      ...
      this.collapsed = false;
      this.hidden = false;
      $body.removeClass('menu-hide menu-open menu-expanded menu-collapsed');
    }
  };
    ...
    bind_events: function () {
      ...
      $('.navigation-main')
        .on('mouseenter.app.menu', 'li', function () {
          ...
          if ($body.hasClass('menu-expanded') && $body.data('menu') != 'vertical-menu-modern') {
      ...
      function modernMenuExpand() {
        if ($body.data('menu') == 'vertical-menu-modern') {
          ...
          if ($body.hasClass('menu-expanded')) {
            ...
            var $listItem = $('.main-menu li.menu-expanded-open'),
            ...
            $listItem.addClass('open').removeClass('menu-expanded-open');
            ...
            if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
              ...
              if ($body.hasClass('menu-expanded')) {
                var $listItem = $('.main-menu li.open'),
                  $subList = $listItem.children('ul');
                $listItem.addClass('menu-expanded-open');
